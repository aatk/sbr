...
let buildNodeCMSPackage = async (params) => {
    ...
    if (params.ext2 === "y") {
        ...
        let defaultFiles = [
            {name: `routers/${shortName}.router.js`, template: "routers/TMP.router.js.tmp"},
            {name: `services/${shortName}.service.js`, template: "services/TMP.service.js.tmp"},
            {name: `services/models/${shortName}.model.js`, template: "services/models/TMP.model.js.tmp"},
            {name: `controllers/${shortName}.controller.js`, template: "controllers/TMP.controller.js.tmp"},

            {name: `db/dtos/${shortName}.dto.js`, template: "db/dtos/TMP.dto.js.tmp"},
            {name: `db/migrations/${nowDate}-create-${shortName}.js`, template: "db/migrations/date-create-TMP.js.tmp"},
            {name: `db/models/${shortName}.js`, template: "db/models/TMP.js.tmp"},
            {name: `db/seeders/${nowDate}-${shortName}.js`, template: "db/seeders/date-TMP.js.tmp"}
        ]
